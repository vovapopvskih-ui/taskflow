...
export function Header({ initialUser }: HeaderProps) {
  ...
  return (
    <header className="sticky top-3 z-50 w-full px-3 sm:px-4">
      <div className="glass mx-auto flex h-14 max-w-5xl items-center justify-between rounded-2xl px-4 sm:px-6">
        {/* Логотип */}
        <Link
        ...
        <div className="flex items-center gap-1.5">
          ...
          {initialUser ? (
            <div className="flex items-center gap-1.5">
              ...
              <Link
                href="/dashboard"
                className="flex items-center gap-2 rounded-xl px-2 py-1 transition-colors hover:bg-secondary/15"
              >
                {initialUser.avatarUrl ? (
                  ...
                  <div className="flex h-7 w-7 items-center justify-center rounded-full bg-secondary/30 text-secondary-foreground ring-1 ring-border/40">
